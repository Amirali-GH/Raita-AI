...
Var
    ...
    LCurrPage, LPageData, Key, Value, LStatus, LContext, LBranchID: String;
...
Begin
    ...
    Try
        Try
            ...
            LCustomerList := ACustomerService.GetAllCustomers(LCurrPage, LStatus, LContext, LBranchID, LTotalSize);
            ...
            Begin
                ...
                Try
                    LPageArrayData := GetPaginationData(lCurrPage.ToInteger,
                                                        LCustomerList.Count,
                                                        PAGE_SIZE,
                                                        BASE_API_V1 + '/customer?branchid=' + IfThen(LBranchID.IsEmpty, '0', LBranchID) +
                                                        '&status=' + IfThen(LStatus.IsEmpty, '0', LStatus) +
                                                        '&context=' + LContext +
                                                        '&page=($page)')
                                                          .ToString.Split([';']);
