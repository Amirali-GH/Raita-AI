        ...
        Try
            ...
            Begin
                ...
                Try
                    ...
                    // تولید GUID بدون آکولاد و خط تیره
                    LGUIDFile := TGUID.NewGuid.ToString;
                    LGUIDFile := StringReplace(LGUIDFile, '{', '', [rfReplaceAll]);
                    LGUIDFile := StringReplace(LGUIDFile, '}', '', [rfReplaceAll]);
                    LGUIDFile := StringReplace(LGUIDFile, '-', '', [rfReplaceAll]);


                    // خروجی: 32 کاراکتر، فقط اعداد و حروف (بدون { } و - )
            ...
            //  دریافت BranchID ها
            // -----------------------------
            LQuery.SQL.Text := 'SELECT BranchID FROM branch_branch WHERE (IsActive = 1) ORDER BY BranchID';
            LQuery.Open;
            Try
            ...
            Try
                ...
                Begin
                    ...
                    LQuery.ParamByName('p_phone').AsString := '0';
