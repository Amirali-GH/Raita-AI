Unit Model.Lead.SourceCollectingData;
...
Type
  ...
  [MVCTable('lead_sourcecollectingdata')]
  [MVCEntityActions([eaRetrieve, eaCreate, eaUpdate, eaDelete])]
  TLead_SourceCollectingData = Class(TMVCActiveRecord)
  Private
    [MVCTableField('SourceCollectingDataID', [foPrimaryKey, foAutoGenerated, foReadOnly])]
  ...
  Public
    ...
    Property Link: NullableString Read FLink Write FLink;
