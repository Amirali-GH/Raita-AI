...
Type
    INovinhubService = Interface ['{6A01CCB5-56F9-427D-B66A-A85BB3D01C14}']
      procedure ImportAssignmentsFromExcel;
    end;
    {Contract}
    IContractService = Interface ['{B4371AB8-E4A6-4C82-A8D3-8451C03F373F}']
    ...
    ICustomerAssignmentService = Interface ['{8AFAEC6B-C1A8-43CD-B77B-FC106BDD3EEA}']
    ...
    {Source}
    ISourceCollectingDataService = Interface ['{A0D3D670-304A-4A7B-AE9A-47272AB9C991}']
    ...
    {Imgae Upload}
    IImageUploadService = Interface ['{6594110B-9210-492A-85B3-768C4D285112}']
    ...
    {Contract Upload}
    IFileResultContractService = Interface ['{BE4236C8-5C2C-447C-8E63-FD97DC1683B2}']
    ...
    ISaleAgentService = Interface ['{02203FC9-1E1B-405C-B39F-5459BAFD122A}']
    ...
    {User}
    IUserService = Interface ['{8D5B4CD2-6B1C-4EC9-BFD8-E4CD8E8F60D3}']
...
Uses
    ...
    Service.UploadImage,
    Service.Lead.SourceCollectingData,
    Service.Contract,
    Service.Novinhub;
...
Begin
    ...
    Container.RegisterType(TNovinhubService, INovinhubService, TRegistrationType.SingletonPerRequest);
    Container.RegisterType(TContractService, IContractService, TRegistrationType.SingletonPerRequest);
    Container.RegisterType(TSourceCollectingDataService, ISourceCollectingDataService, TRegistrationType.SingletonPerRequest);
    ...
    Container.RegisterType(TSaleAgentService, ISaleAgentService, TRegistrationType.SingletonPerRequest);
    Container.RegisterType(TCustomerAssignmentService, ICustomerAssignmentService, TRegistrationType.SingletonPerRequest);
End;
//________________________________________________________________________________________
